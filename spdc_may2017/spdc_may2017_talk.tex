...
\frame {
    ...
    \begin{itemize}
        ...
        \item<1-> Discuss analyses: community structure, ERGMs, SAOMs
...
% 9c
\frame {
    \frametitle{What does the network look like?}
    \begin{itemize}
        \item<1-> Two-mode network of user and beer id's
        \item<1-> Represented as an edgelist
    \end{itemize}
    \begin{table}[ht]
    \centering
    \begin{tabular}{ll}
...
% 9d
\frame {
    \frametitle{Once flattened to a user-to-user network}
    \begin{itemize}
        \item<1-> What do these values in the table represent?
        \item<1-> Why is the matrix symmetrical?
        \item<1-> How could this information be used in a network visualization?
    \end{itemize}
    \begin{table}[ht]
    \tiny
    \centering
...
% 9e
\frame {
    \frametitle{Some descriptive statistics on the network}
    \begin{table}[ht]
        \centering
        \caption{Directed Network Summary}
        \begin{tabular}{lc}
...
% 9f
\frame {
    \frametitle{Beer network visualized}
    \begin{figure}
    \begin{center}
        \includegraphics[height=.65\textwidth]{/Users/mhoover/Dropbox/git/presentations/spdc_may2017/beer_network_FINAL}
        \label{beer1}
        \end{center}
    \end{figure}
...
% 9g
\frame {
    \frametitle{Beer network with tie weight}
    \begin{figure}
    \begin{center}
        \includegraphics[height=.65\textwidth]{/Users/mhoover/Dropbox/git/presentations/spdc_may2017/beer_network_strength_FINAL}
        \label{beer2}
        \end{center}
    \end{figure}
